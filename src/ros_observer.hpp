/**
 *  \file
 *  Observers that log simulation results to ros.
 *
 *  \copyright
 ...
 */
#ifndef COSIM_OBSERVER_ROS_OBSERVER_HPP
#define COSIM_OBSERVER_ROS_OBSERVER_HPP
...
/**
 * An observer implementation, observed variable values are published to ros.
 *
 */
class ros_observer : public observer
{
public:
    /**
     * Creates an observer which logs all variable values to ros format.
     *
     ...
     */
    ros_observer(const cosim::filesystem::path& configPath);
